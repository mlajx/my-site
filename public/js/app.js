...
function onScroll() {
  for (var key in animations) {
    if (animations.hasOwnProperty(key)) {
      ...
      if (!animation.animated && _helpers__WEBPACK_IMPORTED_MODULE_1__["default"].isScrolledIntoView(animation.element)) {
...
var animations = {
  whatIsDevWebFullStack: {
    ...
    animated: false,
    timeline: animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll('.timeline-item').forEach(function (el) {
    ...
    var animation = function animation() {
      if (_helpers__WEBPACK_IMPORTED_MODULE_1__["default"].isScrolledIntoView(el) && !animated) {
        var direction = el.classList.contains('right') ? 10 : -10;
        animated = !animated;
...
__webpack_require__(/*! ./card-hover */ "./resources/js/card-hover.js");

__webpack_require__(/*! ./chamfer */ "./resources/js/chamfer.js");
...
var helpers = {
  isScrolledIntoView: function isScrolledIntoView(el) {
    var completely = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    var rect = el.getBoundingClientRect();
...
__webpack_require__(/*! D:\projects\my-site\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\projects\my-site\resources\css\app.css */"./resources/css/app.css");
