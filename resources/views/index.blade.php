...
<body class="bg-white">
        ...
        <div class="container text-secondary-light">
            ...
            <ul class="project-list">
                ...
                <li class="project-item">
                    <div class="flex flex-col">
                        <div class="relative">
                            <a href="#" class="text-xl font-bold block relative">Jogo da Velha em Vue 3.0</a>
                            <div class="project-popup opacity-0">
                                <p class="project-popup-text">
                                    Um algorítmo desenvolvido em JS que encontra 3 número
                                    palindromos que o resultado deles somados é o
    ...
    <footer class="bg-footer py-4">
        <div class="container text-footer text-xs text-center">
            Site desenvolvido utilizando <a href="#">Laravel</a>, <a href="#">TailwindCss</a>, <a href="#">AnimeJS</a> e <a href="#">ParticlesJs</a>
        </div>
    </footer>
